...
global datasets_broad "es80 es90 es95 es00 es04 es07 es10 es13 es16"
...
foreach ccyy in $datasets_broad {
   ...
   #delimit ;
     gen carework_broad=1 if (year==1980 &
         (inlist(occ1_c, 6,7,13,14,55))
     )
       ;
   #delimit cr

   #delimit ;
      replace carework_broad=1 if (year==1990 &
          (inlist(occ1_c, 6,7,13,14,55))
      )
        ;
   #delimit cr
   ...
   #delimit ;
      replace carework_broad=1 if (year==2010 &
        (
          (inlist(ind1_c, 80,84,85,86,87,88,90,91,93,94))
        & // and
          (inlist(occ1_c, 2200,2300,3200,3300,5100))
        )
      )
   ...
   #delimit ;
      replace carework_broad=1 if (year==2013 &
        (
          (inlist(indd1, 15,16,17,18,19,20))
        & // and

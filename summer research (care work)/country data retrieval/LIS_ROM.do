...
global datasets_broad "ro95 ro97"

global datasets_concise "ro95"
...
foreach ccyy in $datasets_broad {
   ...
   #delimit ;
     gen carework_broad=1 if (year==1995 &
         (inlist(occ1_c, 2220,2310,2320,2330,2340,2350,2430,2460,3220,3230,3310,3320,3330,3340,3450,3460,3480,5130,5140,9130))
     )
       ;
   #delimit cr
...
foreach ccyy in $datasets_concise {
   ...
   #delimit ;
     gen carework_concise=1 if (year==1995 &
